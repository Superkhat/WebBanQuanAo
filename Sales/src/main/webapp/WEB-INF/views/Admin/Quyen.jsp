            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Danh sách quyền </h4> </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <button class="add">
                                           <i class="fa fa-plus-square"></i>  Thêm quyền </button> 
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <c:forEach items="${ListQuyen}" var="quyen">
                                        <tr>
                                            <td>${quyen.id}</td>
                                            <td>${quyen.tenQuyen}</td>
                                            <td>${quyen.moTa}</td>
                                            <td>${quyen.createdby}</td>
                                            <td>${quyen.createdDate}</td>
                                            <td>${quyen.modifiedBy}</td>
                                            <td>${quyen.modifiedDate}</td>
                                            <td>${quyen.status}</td>
                                            ...
                                            <div class="table-data-feature">
                                                     ...
                                                     <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        ...
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                            <a href="/Admin/XoaQuyen${quyen.id}" ><i class="fa fa-trash"></i></a>
                                                        </button>
