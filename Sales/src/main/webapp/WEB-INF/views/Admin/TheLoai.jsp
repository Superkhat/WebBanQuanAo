            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Danh sách thể loại</h4> </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <button class="add">
                                           <i class="fa fa-plus-square"></i>  <a href="/Admin/addTheLoai" >Thêm thể loại </a></button>
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach items="${ListTheLoai}" var="theloai">
                                        <tr>
                                            ...
                                            <td>${theloai.mota}</td>
                                            <td>${theloai.createdby}</td>
                                            <td>${theloai.createdDate}</td>
                                            <td>${theloai.modifiedBy}</td>
                                            <td>${theloai.modifiedDate}</td>
                                            ...
                                            <div class="table-data-feature">
                                                     ...
                                                     <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        ...
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                             <a href="/Admin/XoaTheLoai${theloai.id}" ><i class="fa fa-trash"></i></a>
                                                        </button>
