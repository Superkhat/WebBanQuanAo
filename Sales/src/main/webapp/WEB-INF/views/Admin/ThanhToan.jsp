            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Danh sách phương thức thanh toán</h4> </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <button class="add">
                                          <a href="/Admin/addThanhToan" ><i class="fa fa-plus-square"></i>  Thêm phương thức </a></button> 
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <c:forEach items="${ListThanhToan}" var="thanhtoan">
                                        <tr>
                                            <td>${thanhtoan.id}</td>
                                            <td>${thanhtoan.tenTT}</td>
                                            <td>${thanhtoan.moTa}</td>
                                            <td>${thanhtoan.createdby}</td>
                                            <td>${thanhtoan.createdDate}</td>
                                            <td>${thanhtoan.modifiedBy}</td>
                                            <td>${thanhtoan.modifiedDate}</td>
                                            ...
                                            <div class="table-data-feature">
                                                     ...
                                                     <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        ...
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                           <a href="/Admin/XoaThanhToan${thanhtoan.id}" ><i class="fa fa-trash"></i></a>
                                                        </button>
