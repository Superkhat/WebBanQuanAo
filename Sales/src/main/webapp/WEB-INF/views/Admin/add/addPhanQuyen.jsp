            ...
            <div class="container-fluid">
                ...
                <div class="row row-main">
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <form:form class="form-horizontal form-material" action="/Admin/addPhanQuyen" method="post" modelAttribute="phanquyen">
                                <div class="form-group">
                                    <label class="col-md-12">Tên Quyền</label>
                                    <div class="col-md-12">
                                         <form:select class="form-control form-control-line" path="quyen_phanQuyen.id">
                                        
                                               <form:options items="${quyens}" itemValue="id" itemLabel="tenQuyen" /> 
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <form:input type="text" placeholder="mã người dùng" class="form-control form-control-line" path="nguoidung_phanQuyen.id"/> </div>
                                </div>
